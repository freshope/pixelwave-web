...
const URL = "https://invest-note.pixelwave.app/privacy";
...
export default function InvestNotePrivacyPage() {
  return (
    <div className="wrap">
      <h1>개인정보처리방침</h1>
      <p className="updated">
      ...
      <p>
        투자노트(이하 “서비스”)는 이용자의 개인정보를 소중히 여기며,
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>이용자 직접 입력 또는 증권사 거래내역 파일 업로드</td>
            <td>포트폴리오 분석 및 서비스 제공</td>
          </tr>
          <tr>
            <td>
              매매 메모
      ...
      <p>
        서비스는 위 항목 외의 민감정보(주민등록번호, 금융계좌번호 등)를
        수집하지 않습니다.
      </p>
      ...
      <ul>
        ...
        <li>포트폴리오 분석, 손익 계산 등 핵심 기능 제공</li>
      ...
      <p>
        이용자가 서비스를 탈퇴하거나 개인정보 삭제를 요청한 시점에 즉시
        파기합니다. 단, 관련 법령에 따라 일정 기간 보존이 요구되는 경우 해당
        기간 동안 보관 후 파기합니다.
      </p>
      ...
      <h2>5. 개인정보 처리 위탁</h2>
      <p>서비스는 원활한 서비스 제공을 위해 아래와 같이 처리를 위탁합니다.</p>
      <table>
        <thead>
          <tr>
            <th>수탁 업체</th>
        ...
        <tbody>
          ...
          <tr>
            <td>Apple Inc.</td>
            <td>Apple 소셜 로그인 인증</td>
            <td>각 사 정책에 따름</td>
          </tr>
          <tr>
            <td>Kakao Corp.</td>
            <td>Kakao 소셜 로그인 인증</td>
            <td>각 사 정책에 따름</td>
          </tr>
          <tr>
